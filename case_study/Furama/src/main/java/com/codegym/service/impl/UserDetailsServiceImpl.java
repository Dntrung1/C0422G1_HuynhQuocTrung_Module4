...
@Service
public class UserDetailsServiceImpl<AppUserRepository> implements org.springframework.security.core.userdetails.UserDetailsService {

    @Autowired
    private com.codegym.repository.AppUserRepository appUserRepository;
