...
<form:form action="/edit" method="post" modelAttribute="health">
    ...
    <div class="container-fluid">
        ...
        <div class="input-group mb-3">
            ...
            <form:input type="text" class="form-control" aria-label="Sizing example input"
                        aria-describedby="inputGroup-sizing-default" value="${edit.identityCard}"
                        path="identityCard"/>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <form:input type="text" class="form-control" aria-label="Sizing example input"
                        aria-describedby="inputGroup-sizing-default" value="${edit.vehicleNumber}"
                        path="vehicleNumber"/>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <form:input type="text" class="form-control" aria-label="Sizing example input"
                        aria-describedby="inputGroup-sizing-default" value="${edit.seats}"
                        path="seats"/>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <form:input type="text" class="form-control" aria-label="Sizing example input"
                        aria-describedby="inputGroup-sizing-default" value="${edit.note}"
                        path="note"/>
        </div>
